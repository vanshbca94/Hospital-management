document.addEventListener("DOMContentLoaded", () => {
  // ---------------------------------
  // ANIMATED BOOK APPOINTMENT BUTTON (on index.html)
  // ---------------------------------
  ...
  if (confBtn) {
    confBtn.addEventListener("click", (e) => {
      ...
      burst();              // run confetti 🎉
      setTimeout(() => {
        window.location.href = confBtn.href;  // redirect after animation
      }, 700);
    });
  }

  // ---------------------------------
  // APPOINTMENT FORM (on appointment.html)
  // ---------------------------------
  ...
  // ---------------------------------
  // ATTENDANCE FORM (on attendance.html)
  // ---------------------------------
  ...
  // ---------------------------------
  // CONFETTI ANIMATION (shared across all pages)
  // ---------------------------------
  function burst() {
    for (let i = 0; i < 25; i++) {
